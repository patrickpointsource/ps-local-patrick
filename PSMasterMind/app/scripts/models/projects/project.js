...
angular.module( 'Mastermind.models.projects' ).factory( 'Terms', function( ) {
	var defaults = {
	...
	return Terms;
} ).factory( 'Role', [ 'Rates', 'RateFactory', 'Assignment',
function( Rates, RateFactory, Assignment ) {
	/**
	...
	return Role;
} ] ).factory( 'Assignment', [ 'Rates', 'RateFactory',
function( Rates, RateFactory ) {
	/**
	 * The defaults for a newly created role.
	 *
	 * @type {{rate: HourlyRate, shore: string}}
...
function( Terms, Role ) {
	...
	function Project( options ) {
		...
		this._rev = options._rev || defaults._rev;
	...
	Project.prototype.removeRole = function( role ) {
		var roles = this.roles, roleIndex = roles.indexOf( role );
	...
	Project.prototype.validate = function( ) {
		var self = this, messages = _( this.$meta.rules ).filter( function( validator ) {
