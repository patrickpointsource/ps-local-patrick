        ...
        function ($rootScope, $scope, $state, $filter, $location, TableParams, ProjectsService, Resources) {
            ...
            $scope.handleProjectFilterChanged = function () {
                ...
                if ($scope.projectFilter != $state.params.filter) {
                    var updatedUrl = $state.href('projects.index', {
            ...
            $scope.changeSort = function (type) {
                ...
                if (type === 'proj-desc') {
                    $scope.projects = _.sortBy($scope.projects, function (proj) {
                ...
                if (type === 'cust-desc') {
                    $scope.projects = _.sortBy($scope.projects, function (proj) {
                        return proj.customerName.toLowerCase();
                    });
                }
