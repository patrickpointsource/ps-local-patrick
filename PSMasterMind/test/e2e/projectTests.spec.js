describe("E2E: Project test cases.", function () {
    ...
    var projectsList = {
    		active: [ "E2E Hours widget - Active Project",
    	              "MasterMind",
    ...
    it('Check actual hours for the project.', function () {
    	selectProject(HOURS_WIDGET_PROJECT_NAME, projectsPath.active, checkActualHours);
    }, 120000);
...
//    	});
    ...
    var checkActualHours = function () {
    	var projectPage = new ProjectPage();
		browser.wait(function () {
			return browser.isElementPresent(projectPage.editButton);
		}).then(function () {
			console.log("> Check actual hours for the project.");
