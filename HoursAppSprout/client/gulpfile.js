...
gulp.task('uglify-dependencies', function () {
  var libs = [
    ...
    'bower_components/psaf-worklight/worklight.module.js',
    'bower_components/psaf-worklight/worklight.service.js',
    'bower_components/psaf-worklight/worklight.factory.js'
  ];
